...
namespace Xabe.FFmpeg
{
    ...
    public interface IConversion
    {
        ...
        /// <exception cref="InvalidOperationException"></exception>
        /// <exception cref="ObjectDisposedException"></exception>
        Task<IConversionResult> Start(string parameters, Action<int> @event);
        ...
        /// <exception cref="ObjectDisposedException"></exception>
        /// <exception cref="TaskCanceledException">Occurs when task was cancalled.</exception>
        Task<IConversionResult> Start(string parameters, Action<int> @event, CancellationToken cancellationToken);
