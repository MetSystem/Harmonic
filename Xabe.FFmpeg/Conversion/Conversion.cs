...
namespace Xabe.FFmpeg
{
    ...
    public partial class Conversion : IConversion
    {
        ...
        {
            return Start(Build(), null);
        }

        /// <inheritdoc />
        public Task<IConversionResult> Start(CancellationToken cancellationToken)
        {
            return Start(Build(), null, cancellationToken);
        }

        /// <inheritdoc />
        public Task<IConversionResult> Start(string parameters, Action<int> @event)
        {
            return Start(parameters, @event, new CancellationToken());
        }

        /// <inheritdoc />
        public async Task<IConversionResult> Start(string parameters, Action<int> @event, CancellationToken cancellationToken)
        {
            if (_ffmpeg != null)
            {
            ...
            await _ffmpeg.RunProcess(parameters, @event, cancellationToken, _priority);
